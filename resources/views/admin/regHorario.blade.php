        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden relative">
            ...
            <div class="p-8 sm:p-10">
                <div class="text-center mb-10">
                    ...
                    <p class="mt-2 text-sm text-slate-500">Asigna un horario para la materia de <strong
                            class="text-slate-800">{{ $materia->nombre }}</strong></p>
                </div>
                ...
                <form action="{{ route('save.horario') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="user_id" class="block text-sm font-semibold text-slate-700 mb-2">Asignar
                            Docente/Usuario</label>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            @foreach (['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado'] as $dia)
                                <label
                                    class="relative flex cursor-pointer rounded-xl border border-slate-200 bg-slate-50 p-4 shadow-sm hover:border-emerald-400 focus-within:ring-2 focus-within:ring-emerald-500/20 transition-all">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            <label for="hora_inicio" class="block text-sm font-semibold text-slate-700 mb-2">Hora de
                                Inicio</label>
                        ...
                        <div>
                            <label for="hora_fin" class="block text-sm font-semibold text-slate-700 mb-2">Hora de
                                Fin</label>
