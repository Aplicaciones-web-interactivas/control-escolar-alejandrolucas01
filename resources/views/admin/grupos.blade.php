...
@section('title', 'Administración de Grupos - Control Escolar')
...
@section('content')
    ...
    @if (session('success'))
        <div
            ...
            <svg class="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                fill="currentColor">
    ...
    <div class="card">
        <div class="card-header">
            <div>
                <h2 class="text-lg font-bold text-slate-900 border-l-4 border-indigo-500 pl-3">Grupos Existentes</h2>
                <p class="text-sm text-slate-500 mt-1 pl-4">Lista completa de grupos asignados a materias y horarios.</p>
            </div>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="table-header">
                        ...
                        <th class="table-th text-center">Docente</th>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors duration-150 group">
                            ...
                            <td class="py-4 px-6">
                                <div class="flex flex-col">
                                    <span class="text-sm font-medium text-slate-800">{{ $grupo->horario->dia }}</span>
                                    <span
